...
class _DashboardTabState extends State<DashboardTab> {
  ...
  checkForNew() async {
    ...
    List userInfo = preferences.getStringList("user");

    print("ChannelList: $channelList");
    print("UId: ${userInfo[0]}");

    if (isSame == "false") {
      // Check if the current logged in user equals either the sender or the receiver
      if (channelList[0] == userInfo[0] || channelList[1] == userInfo[0]) {
        runNotif();
        showNotification();
        print(isSame);
      }
